...
public class SpringBackScrollview extends ScrollView {
    ...
    @SuppressLint("NewApi")
    public SpringBackScrollview(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
    }

    private void init(Context context) {
        effectiveScrollY = DeviceUtil.getScreenHeight(context) / 4;
    }
...
//                Log.d("TAG", "ACTION_MOVE");
                ...
                if (shouldMove) {
                    //计算偏移量
                    int offset = (int) (deltaY * SCROLL_RATIO);
                    //随着手指的移动而移动布局
